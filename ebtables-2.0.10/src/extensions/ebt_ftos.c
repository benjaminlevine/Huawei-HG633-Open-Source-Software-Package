   ...
   struct ebt_entry_target **target)
{
	...
	case FTOS_SETFTOS:
		...
		/* Start of modified by f00120964 for  qos ipp/tos mark 2012-03-08 */
		ftosinfo->ftos = (unsigned int)strtoul(optarg, &end, 0);
		//ftosinfo->ftos = (u_int8_t)strtoul(optarg, &end, 0);
		/* End of modified by f00120964 for  qos ipp/tos mark 2012-03-08 */
