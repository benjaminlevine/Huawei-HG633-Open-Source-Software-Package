...
{
	{ "accmark-target" , required_argument, 0, MARK_TARGET },
	/* an oldtime messup, we should have always used the scheme
	 * <extension-name>-<option> */
	{ "set-accmark"    , required_argument, 0, MARK_SETMARK },
	{ "accmark-set"    , required_argument, 0, MARK_SETMARK },
	{ "accmark-or"     , required_argument, 0, MARK_ORMARK  },
	{ "accmark-and"    , required_argument, 0, MARK_ANDMARK },
	{ "accmark-xor"    , required_argument, 0, MARK_XORMARK },
	{ "vtag-setaccmark"    , required_argument, 0, MARK_SETVTAG },
	{ 0 }
};
...
{
	struct ebt_accmark_t_info *markinfo =
	   (struct ebt_accmark_t_info *)target->data;
...
{
	struct ebt_accmark_t_info *markinfo1 =
	   (struct ebt_accmark_t_info *)t1->data;
	struct ebt_accmark_t_info *markinfo2 =
	   (struct ebt_accmark_t_info *)t2->data;
...
static struct ebt_u_target mark_target =
{
	...
	.size		= sizeof(struct ebt_accmark_t_info),
	.help		= print_help,
	.init		= init,
	.parse		= parse,
