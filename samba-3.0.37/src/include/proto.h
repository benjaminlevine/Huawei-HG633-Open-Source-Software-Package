...
const struct in_addr *iface_n_sockaddr_storage(int n);
...
int lp_max_visit_times(void);
int lp_retry_sleep_seconds(void);
char *lp_preexec(int );
...
void process_smbd_user_pid(int flag, char *user,int pid);
