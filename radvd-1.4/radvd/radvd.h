/*
 *   $Id: radvd.h,v 1.1 2009/08/22 07:51:01 y42304 Exp $
 *
 *   Authors:
...
#define RADVD_LOCAL_FILE		"/var/radvd/radvdlocal.conf"
#define RADVD_PREFIX_BUF		(128)
#define RADVD_FILE_BUF		(257)
#endif
/* for log.c */
#define	L_NONE		0
#define L_SYSLOG	1
