...
#define CUPS_SVERSION "CUPS v1.6.1"
#define CUPS_MINIMAL "CUPS/1.6.1"
...
#define CUPS_DEFAULT_LPD_CONFIG_FILE "xinetd:///etc/xinetd.d/cups-lpd"
...
#define CUPS_DATADIR "/etc/cups"
#define CUPS_DOCROOT "/etc/doc/cups"
#define CUPS_FONTPATH "/etc/cups/fonts"
#define CUPS_LOCALEDIR "/etc/locale"
