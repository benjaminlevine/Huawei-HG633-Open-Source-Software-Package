...
#undef CONFIG_FEATURE_EDITING_FANCY_KEYS
#define ENABLE_FEATURE_EDITING_FANCY_KEYS 0
#define USE_FEATURE_EDITING_FANCY_KEYS(...)
#define SKIP_FEATURE_EDITING_FANCY_KEYS(...) __VA_ARGS__
...
#define USE_FEATURE_FIND_NOT(...)
#define SKIP_FEATURE_FIND_NOT(...) __VA_ARGS__
...
#define USE_CONFIG_FLASH_ERASEALL(...)
...
#define ENABLE_HTTPDIAG 0
#define USE_HTTPDIAG(...)
#define SKIP_HTTPDIAG(...) __VA_ARGS__
...
#define ENABLE_SMUXCTL 1
#define USE_SMUXCTL(...) __VA_ARGS__
#define SKIP_SMUXCTL(...)
#undef CONFIG_WGET
...
#define USE_MPSTAT(...)
#define SKIP_MPSTAT(...) __VA_ARGS__
...
#define ENABLE_ATP_FTP 1
#define USE_ATP_FTP(...) __VA_ARGS__
#define SKIP_ATP_FTP(...)
#define CONFIG_ATP_FTPGET 1
#define ENABLE_ATP_FTPGET 1
#define USE_ATP_FTPGET(...) __VA_ARGS__
#define SKIP_ATP_FTPGET(...)
#define CONFIG_ATP_FTPPUT 1
#define ENABLE_ATP_FTPPUT 1
#define USE_ATP_FTPPUT(...) __VA_ARGS__
#define SKIP_ATP_FTPPUT(...)
#undef CONFIG_FEATURE_ATP_FTP_ZIP
#define ENABLE_FEATURE_ATP_FTP_ZIP 0
#define USE_FEATURE_ATP_FTP_ZIP(...)
#define SKIP_FEATURE_ATP_FTP_ZIP(...) __VA_ARGS__
#define CONFIG_ATP_PING 1
#define ENABLE_ATP_PING 1
#define USE_ATP_PING(...) __VA_ARGS__
#define SKIP_ATP_PING(...)
#define CONFIG_ATP_PING6 1
#define ENABLE_ATP_PING6 1
#define USE_ATP_PING6(...) __VA_ARGS__
#define SKIP_ATP_PING6(...)
#undef CONFIG_ATP_IFENSLAVE
#define ENABLE_ATP_IFENSLAVE 0
#define USE_ATP_IFENSLAVE(...)
#define SKIP_ATP_IFENSLAVE(...) __VA_ARGS__
#undef CONFIG_FEATURE_ATP_FTPGETPUT_LONG_OPTIONS
#define ENABLE_FEATURE_ATP_FTPGETPUT_LONG_OPTIONS 0
#define USE_FEATURE_ATP_FTPGETPUT_LONG_OPTIONS(...)
#define SKIP_FEATURE_ATP_FTPGETPUT_LONG_OPTIONS(...) __VA_ARGS__
#undef CONFIG_ATP_TFTP
#define ENABLE_ATP_TFTP 0
#define USE_ATP_TFTP(...)
#define SKIP_ATP_TFTP(...) __VA_ARGS__
#define CONFIG_ATP_ARP 1
#define ENABLE_ATP_ARP 1
#define USE_ATP_ARP(...) __VA_ARGS__
#define SKIP_ATP_ARP(...)
#undef CONFIG_FEATURE_ATP_TFTP_GET
#define ENABLE_FEATURE_ATP_TFTP_GET 0
#define USE_FEATURE_ATP_TFTP_GET(...)
#define SKIP_FEATURE_ATP_TFTP_GET(...) __VA_ARGS__
#undef CONFIG_FEATURE_ATP_TFTP_PUT
#define ENABLE_FEATURE_ATP_TFTP_PUT 0
#define USE_FEATURE_ATP_TFTP_PUT(...)
#define SKIP_FEATURE_ATP_TFTP_PUT(...) __VA_ARGS__
#undef CONFIG_FEATURE_ATP_TFTP_BLOCKSIZE
#define ENABLE_FEATURE_ATP_TFTP_BLOCKSIZE 0
#define USE_FEATURE_ATP_TFTP_BLOCKSIZE(...)
#define SKIP_FEATURE_ATP_TFTP_BLOCKSIZE(...) __VA_ARGS__
#undef CONFIG_FEATURE_ATP_TFTP_ZIP
#define ENABLE_FEATURE_ATP_TFTP_ZIP 0
#define USE_FEATURE_ATP_TFTP_ZIP(...)
#define SKIP_FEATURE_ATP_TFTP_ZIP(...) __VA_ARGS__
#define CONFIG_ATP_WGET 1
#define ENABLE_ATP_WGET 1
#define USE_ATP_WGET(...) __VA_ARGS__
#define SKIP_ATP_WGET(...)
#undef CONFIG_FEATURE_ATP_WGET_STATUSBAR
#define ENABLE_FEATURE_ATP_WGET_STATUSBAR 0
#define USE_FEATURE_ATP_WGET_STATUSBAR(...)
#define SKIP_FEATURE_ATP_WGET_STATUSBAR(...) __VA_ARGS__
#define CONFIG_FEATURE_ATP_WGET_AUTHENTICATION 1
#define ENABLE_FEATURE_ATP_WGET_AUTHENTICATION 1
#define USE_FEATURE_ATP_WGET_AUTHENTICATION(...) __VA_ARGS__
#define SKIP_FEATURE_ATP_WGET_AUTHENTICATION(...)
#define CONFIG_FEATURE_ATP_WGET_HTTPS 1
#define ENABLE_FEATURE_ATP_WGET_HTTPS 1
#define USE_FEATURE_ATP_WGET_HTTPS(...) __VA_ARGS__
#define SKIP_FEATURE_ATP_WGET_HTTPS(...)
#undef CONFIG_FEATURE_ATP_WGET_ZIP
#define ENABLE_FEATURE_ATP_WGET_ZIP 0
#define USE_FEATURE_ATP_WGET_ZIP(...)
#define SKIP_FEATURE_ATP_WGET_ZIP(...) __VA_ARGS__
#undef CONFIG_FEATURE_ATP_WGET_LONG_OPTIONS
#define ENABLE_FEATURE_ATP_WGET_LONG_OPTIONS 0
#define USE_FEATURE_ATP_WGET_LONG_OPTIONS(...)
#define SKIP_FEATURE_ATP_WGET_LONG_OPTIONS(...) __VA_ARGS__
#undef CONFIG_ATP_MCAST
#define ENABLE_ATP_MCAST 0
#define USE_ATP_MCAST(...)
#define SKIP_ATP_MCAST(...) __VA_ARGS__
#undef CONFIG_FEATURE_ATP_MCAST_ZIP
#define ENABLE_FEATURE_ATP_MCAST_ZIP 0
#define USE_FEATURE_ATP_MCAST_ZIP(...)
#define SKIP_FEATURE_ATP_MCAST_ZIP(...) __VA_ARGS__
#undef CONFIG_FEATURE_ATP_MCAST_USPACE
#define ENABLE_FEATURE_ATP_MCAST_USPACE 0
#define USE_FEATURE_ATP_MCAST_USPACE(...)
#define SKIP_FEATURE_ATP_MCAST_USPACE(...) __VA_ARGS__
#undef CONFIG_FEATURE_ATP_MCAST_BOOTLOADER
#define ENABLE_FEATURE_ATP_MCAST_BOOTLOADER 0
#define USE_FEATURE_ATP_MCAST_BOOTLOADER(...)
#define SKIP_FEATURE_ATP_MCAST_BOOTLOADER(...) __VA_ARGS__
#define CONFIG_ATP_TRACEROUTE6 1
#define ENABLE_ATP_TRACEROUTE6 1
#define USE_ATP_TRACEROUTE6(...) __VA_ARGS__
#define SKIP_ATP_TRACEROUTE6(...)
