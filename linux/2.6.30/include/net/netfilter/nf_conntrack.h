...
#define RESERVE_MARK        (0x0000F000)
#define RESERVE_MASK        (0x0000F000)
#endif
...
#if defined(CONFIG_DPI_PARSE) || defined(CONFIG_ARCH_SD56XX)
    u_int32_t  ulProtoID;
	u_int32_t  ulcounter;
    u_int32_t  ulRank; 
	bool       bIsContinue;
...
#ifdef CONFIG_RESERVE_CT_SESSION
extern unsigned int nf_reserve_ct_min;
#endif
