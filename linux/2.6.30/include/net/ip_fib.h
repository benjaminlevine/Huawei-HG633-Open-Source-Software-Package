...
struct fib_hook
{
    int (*tb_fib_add)(struct fib_config*);
    int (*tb_fib_del)(struct fib_config*);
};
#endif
...
/*start by HSANV200R001C01B057 增加组播硬件加速功能 2013-3-30*/
#ifdef CONFIG_HSAN
extern int fib_walk(struct fib_table *tb, int (*func)(struct fib_config*));
extern int fib_hook_reg(struct fib_hook *hook);
extern int fib_hook_unreg(void);
#endif
/*end by HSANV200R001C01B057 增加组播硬件加速功能 2013-3-30*/
