...
extern struct port_relay g_portrelay;
#endif

/*START: add by h00190880 for CT dhcps devrelay at 2013-1-17*/
#ifdef CONFIG_BRIDGE_DEV_RELAY
#define DEV_RELAY_NUM 4
struct dev_relay
{
    int iEnable[DEV_RELAY_NUM];
};
extern struct dev_relay g_devrelay;
#endif
...
#elif defined(CONFIG_BROADCOM_RELEASE_VERSION_4_12_L08)
	struct net_device_ops *netdev_ops;
#else
...
extern int		weight_p;
#ifdef CONFIG_ATP_SUPPORT_HG253
