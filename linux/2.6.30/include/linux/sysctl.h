...
enum
{
	...
	KERN_LOCAL_TIME_OFFSET=78, /*int: local time and utc time offset in seconds*/
...
/* END:   Added by z67728, 2010/8/5 */
	NET_IPV4_IPFRAG_COUNT_THRESH=129,  /* add ipfrag count for DTS2012010607398 by f00110348 20120119 */
	/* QGT: HOMEGW-8359 add */
	#ifdef CONFIG_DT_QOS
	NET_IPV4_IGMP_QUERY_TOS = 130,
        /*begin, DT: LAN 侧查询使用wan侧获得的QQIC / Max Resp Code */
        NET_IPV4_IGMP_QUERY_QQIC = 131,
        NET_IPV4_IGMP_QUERY_MRT = 132,
        NET_IPV4_IGMP_QUERY_QRV = 133,
...
/* end of add by d00107688 2009-04-15 to support alg switch */
	...
	NET_IPV4_NF_CT_RESERVE_CNT_MIN=58,
	NET_IPV4_NF_CT_RESERVE_COUNT=59,    	
#endif
/*start added by t00191685 for HG658B_STC LAN-WAN自动桥绑定,2011-12-19*/
#if defined(CONFIG_NF_CONNTRACK_BR_AUTOBIND)    
    NET_IPV4_NF_BR_AUTOBIND=60,
#endif
/*end added by t00191685 for HG658B_STC LAN-WAN自动桥绑定,2011-12-19*/
...
enum {
	...
	/* BEGIN: Added by l00184769, 2013/7/18 For port scan */
	NET_IPV6_UDP_PORT_SCAN=26,
	/* END:   Added by l00184769, 2013/7/18 */
};
