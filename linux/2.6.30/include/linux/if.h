...
#define IFF_ALLOWPASS 0x80000 /*allow packet from other brigde to pass*/
...
#if defined(CONFIG_BCM96816) && defined(CONFIG_BCM_GPON_MODULE)
#define IFF_HW_SWITCH  0x0000
#else /* All platforms including 6819_BHR except 6816 w/ GPON */
