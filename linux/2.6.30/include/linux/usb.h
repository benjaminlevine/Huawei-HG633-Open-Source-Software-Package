...
#if (defined CONFIG_HSAN) && (!defined(CONFIG_USB_HSAN_USB3_0))
...
/*<DTS2010112202771  通过接入顺序来判断usb设备begin*/
#define USB_DEVICE_ID_MATCH_HUAWEI  (USB_DEVICE_ID_MATCH_INT_SEQUENCE | USB_DEVICE_ID_MATCH_VENDOR)
#if defined(CONFIG_USB_HSAN_USB3_0)
#define USB_DEVICE_ID_MATCH_HUAWEI_NDIS  (USB_DEVICE_ID_MATCH_INT_SEQUENCE | USB_DEVICE_ID_MATCH_VENDOR |  USB_DEVICE_ID_MATCH_PRODUCT)

#define FMC_USB_DEVICE_MATCH_HUAWEI_NDIS(intseq,vend,prod) \
    .match_flags = USB_DEVICE_ID_MATCH_HUAWEI_NDIS, \
    .idVendor = (vend), \
...
#define USB_DEVICE(vend,prod) \
	...
	.idVendor = (vend), \
	.idProduct = (prod)
/* BEGIN: Added by c106292, 2009/11/10   PN:  HwDataCard */
...
#endif
/* END:   Added by c106292, 2009/11/10 */
/**
