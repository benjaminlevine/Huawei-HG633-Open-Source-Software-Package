...
static struct resource hiusb_ehci_res[] = {
        [0] = {
                .start = CONFIG_USB_HSAN_EHCI_IOBASE,
                .end   = CONFIG_USB_HSAN_EHCI_IOBASE + CONFIG_USB_HSAN_EHCI_IOSIZE - 1,
                .flags = IORESOURCE_MEM,
        },
        [1] = {
                .start = CONFIG_USB_HSAN_EHCI_IRQNUM,
                .end   = CONFIG_USB_HSAN_EHCI_IRQNUM,
