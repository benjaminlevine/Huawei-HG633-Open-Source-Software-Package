...
static struct resource hiusb_ohci_res[] = {
        [0] = {
                .start = CONFIG_USB_HSAN_OHCI_IOBASE,
                .end   = CONFIG_USB_HSAN_OHCI_IOBASE + CONFIG_USB_HSAN_OHCI_IOSIZE - 1,
                .flags = IORESOURCE_MEM,
        },
        [1] = {
                .start = CONFIG_USB_HSAN_OHCI_IRQNUM,
                .end   = CONFIG_USB_HSAN_OHCI_IRQNUM,
