...
//#include "hipciev100/pcie_godbox.h"
...
/* For HSAN pcie controller fixup */
static void __devinit quirk_hsan_isr(struct pci_dev  *dev)
{
	unsigned char irq;
	struct pci_bus *bus;
...
DECLARE_PCI_FIXUP_HEADER(PCI_ANY_ID, PCI_ANY_ID, quirk_hsan_isr);


//#include "hipciev101/pcie_godbox_1.h"

/* For hsan pcie controller fixup */
static void __devinit quirk_hsan_isr1(struct pci_dev  *dev)
{
	unsigned char irq;
	struct pci_bus *bus;
...
DECLARE_PCI_FIXUP_HEADER(PCI_ANY_ID, PCI_ANY_ID, quirk_hsan_isr1);
