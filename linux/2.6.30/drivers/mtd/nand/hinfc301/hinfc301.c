...
static void hinfc301_select_chip(struct mtd_info *mtd, int chipselect)
{
	...
	if (chipselect > CONFIG_MTD_HISI_SD5610_NFC_MAX_CHIP)	
#endif	
	{
...
#if defined(CONFIG_MTD_HISI_SD5115_NFC_HARDWARE_PAGESIZE_ECC) || defined(CONFIG_MTD_HISI_SD5610_NFC_HARDWARE_PAGESIZE_ECC)
...
#if defined(CONFIG_MTD_HISI_SD5115_NFC_AUTO_PAGESIZE_ECC) || defined(CONFIG_MTD_HISI_SD5610_NFC_AUTO_PAGESIZE_ECC)
...
#if defined(CONFIG_MTD_HISI_SD5115_NFC_PAGESIZE_AUTO_ECC_NONE) || defined(CONFIG_MTD_HISI_SD5610_NFC_PAGESIZE_AUTO_ECC_NONE)
	{
		int pagetype;
...
#if defined(CONFIG_HISI_SD5115) || defined(CONFIG_HISI_SD5610)
...
#elif defined(CONFIG_HISI_SD5610)
	if (nand_scan(mtd, CONFIG_MTD_HISI_SD5610_NFC_MAX_CHIP)) 
#endif
	{
		result = -ENXIO;
		goto err;
...
#if defined(CONFIG_BUILD_CUSTOM_FMC_PRODUCT)
            /* fmc上不支持该接口 */
#else
...
{
	{
		.start  = CONFIG_MTD_HISI_SD5610_NFC_REG_BASE_ADDRESS,
		.end    = CONFIG_MTD_HISI_SD5610_NFC_REG_BASE_ADDRESS + HINFC301_REG_BASE_ADDRESS_LEN,
		.flags  = IORESOURCE_MEM,
	},

	{
		.start  = CONFIG_MTD_HISI_SD5610_NFC_BUFFER_BASE_ADDRESS,
		.end    = CONFIG_MTD_HISI_SD5610_NFC_BUFFER_BASE_ADDRESS + HINFC301_BUFFER_BASE_ADDRESS_LEN,
		.flags  = IORESOURCE_MEM,
	},
	{
		.start = CONFIG_MTD_HISI_SD5610_NFC_PERIPHERY_REGBASE,
		.end   = CONFIG_MTD_HISI_SD5610_NFC_PERIPHERY_REGBASE + 100,
		.flags = IORESOURCE_MEM,
	},
};
#endif
