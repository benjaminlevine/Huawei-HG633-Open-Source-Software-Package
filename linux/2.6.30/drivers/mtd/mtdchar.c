    ...
    case MEMEWRITEPAGE:
        {
            ...
            if (copy_to_user(&buf_user->oob_len, &ops.oobretlen, sizeof(buf_user->oob_len)))
                return -EFAULT;

            if (copy_to_user(&buf_user->data_len, &ops.retlen, sizeof(buf_user->data_len)))
                return  -EFAULT;
    ...
    case MEMEREADPAGE:
        {
            ...
            if(copy_to_user(buf_user->oob_ptr, ops.oobbuf, ops.oobretlen)
                ...
                || copy_to_user(&buf_user->oob_len, &ops.oobretlen, sizeof(buf_user->oob_len))
                || copy_to_user(&buf_user->data_len, &ops.retlen, sizeof(buf_user->data_len))){
