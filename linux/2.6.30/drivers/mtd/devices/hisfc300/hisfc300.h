...
#define HISFC300H
/******************************************************************************/
#ifndef CONFIG_MTD_HISI_SFC_REG_BASE_ADDRESS
#  define CONFIG_MTD_HISI_SFC_REG_BASE_ADDRESS            (0x10A20000)
#  warning NOT config CONFIG_MTD_HISI_SFC_REG_BASE_ADDRESS, used default value, maybe invalid.
#endif /* CONFIG_MTD_HISI_SFC_REG_BASE_ADDRESS */

#ifndef CONFIG_MTD_HISI_SFC_BUFFER_BASE_ADDRESS
#  define CONFIG_MTD_HISI_SFC_BUFFER_BASE_ADDRESS         (0x1C000000)
#  warning NOT config CONFIG_MTD_HISI_SFC_BUFFER_BASE_ADDRESS, used default value, maybe invalid.
#endif /* CONFIG_MTD_HISI_SFC_BUFFER_BASE_ADDRESS */

//#ifndef CONFIG_MTD_HISI_SFC_PERIPHERY_REGBASE
//#  define CONFIG_MTD_HISI_SFC_PERIPHERY_REGBASE           (0x101F5000)
//#  warning NOT config CONFIG_MTD_HISI_SFC_PERIPHERY_REGBASE, used default value, maybe invalid.
//#endif /* CONFIG_MTD_HISI_SFC_PERIPHERY_REGBASE */

#ifndef CONFIG_MTD_HISI_SFC_CHIPNUM
#  define CONFIG_MTD_HISI_SFC_CHIPNUM                    (2)
#  warning NOT config CONFIG_MTD_HISI_SFC_CHIPNUM, used default value, maybe invalid.
#endif /* CONFIG_MTD_HISI_SFC_CHIPNUM */
...
struct hisfc_host 
{
	...
	struct hisfc_spi spi[CONFIG_MTD_HISI_SFC_CHIPNUM+1];
