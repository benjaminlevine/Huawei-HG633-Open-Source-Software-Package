...
extern int set_rmnet_device(struct usb_device * rmnet_device, struct usb_host_interface * rmnet_intf);
extern int set_rmnet_intr_ep(struct usb_endpoint_descriptor * ep_int);
extern int trigger_tty(void);
extern int exit_tty(void);
extern int set_hwcdc_device(struct hw_cdc_net *dev, struct usb_host_interface * hw_cdc_net_intf);
