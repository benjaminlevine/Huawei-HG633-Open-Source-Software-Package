...
/*w723v 问题单AU8D04132 by g00121640  2010-2-21 start*/
...
static rwlock_t s_dt_skb_buf_lock = RW_LOCK_UNLOCKED;
...
/****** DT c40163 end ******/
/*w723v 问题单AU8D04132 by g00121640  2010-2-21 end*/
...
/*START ADD: W00182511 2011/11/9  FOR DTS2011101401709/DTS2011100700422*/
static int pppoe_delete_po(struct pppox_sock *po)
{
    int i = 0;
    int iCnt = 0;
    struct pppox_sock *ret, **src;
...
/*END ADD: W00182511 2011/11/9  FOR DTS2011101401709/DTS2011100700422*/
...
static int __pppoe_xmit(struct sock *sk, struct sk_buff *skb)
{
	...
	/*Start of added by f0120964 for qos function 2012-1-6 */
	#ifdef CONFIG_IMQ
	/* if qos enable, all packet to IMQ */
    skb->mark |= QOS_DEFAULT_MARK;
	#endif 
	/*End of added by f0120964 for qos function 2012-1-6 */
	dev_queue_xmit(skb);
