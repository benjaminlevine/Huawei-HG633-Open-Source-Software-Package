	     ...
	     gpt_header **gpt, gpt_entry **ptes)
{
...
#if defined(CONFIG_MIPS_BRCM) || defined(CONFIG_HSAN)
		printk("GUID Partition Table Header signature is wrong:"
			 "%lld != %lld\n",
	...
	if (crc != origcrc) {
#if defined(CONFIG_MIPS_BRCM) || defined(CONFIG_HSAN)
		printk("GUID Partition Table Header CRC is wrong: %x != %x\n",
			 crc, origcrc);
#else
...
#if defined(CONFIG_MIPS_BRCM) || defined(CONFIG_HSAN)
		printk("GPT my_lba incorrect: %lld != %lld\n",
...
#if defined(CONFIG_MIPS_BRCM) || defined(CONFIG_HSAN)
		printk("GPT: first_usable_lba incorrect: %lld > %lld\n",
...
#if defined(CONFIG_MIPS_BRCM) || defined(CONFIG_HSAN)
		printk("GPT: last_usable_lba incorrect: %lld > %lld\n",
...
#if defined(CONFIG_MIPS_BRCM) || defined(CONFIG_HSAN)
		printk("GUID Partitition Entry Array CRC check failed.\n");
#else
