...
/* Start of added by f00120964 for enable qos uplink 2013-3-11 */
#ifdef CONFIG_QOS_IPV6
    /* if qos enable, all packet to ifb */
    skb->mark |= QOS_DEFAULT_MARK;
#endif
/* End of added by f00120964 for enable qos uplink 2013-3-11 */

#ifdef CONFIG_ATP_HYBRID_GREACCEL
    if ((IPPROTO_GRE == ipv6_hdr(skb)->nexthdr) && (skb->mark & PPP_TRIGER_MARK))
    {
        return ip6_output_finish(skb);
    }
#endif
