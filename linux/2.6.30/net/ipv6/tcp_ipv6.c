...
static inline void syn_flood_warning(struct sk_buff *skb)
{
...
#ifdef CONFIG_FIREWALL_LOG
	{
		...
		if (NULL != pszLogBuf)
		{
			...
			snprintf(pszLogBuf, ATP_LOG_LENGTH_128, "Detect ipv6 Syn Flood Attack, packet from %pI6.\n", &(ipv6_hdr(skb)->saddr));
				 ...
				 u32 ts, struct tcp_md5sig_key *key, int rst)
{
    ...
    /*Start of ATP 2013-3-8 for HOMEGW-15781 by t00189036: Data IPv6 LAN nmap scan reboots HG*/
    /*skb->transport_header没有赋值导致后续q931_help中直接使用时网关死机*/
    /*合入36内核对此的修改*/
	skb_reset_transport_header(buff);
    /*End of ATP 2013-3-8 for HOMEGW-15781 by t00189036*/
