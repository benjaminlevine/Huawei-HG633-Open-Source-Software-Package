...
/*Start for DTS2014022206690  2.4G 设置为20M WMM功能不生效 by z00190439 2014-03-14*/
#if defined(CONFIG_ARCH_SD56XX) 
#define SKB_MARK_DSCP_REMARK_ENABLE    0x8 
#endif
/*End for DTS2014022206690  2.4G 设置为20M WMM功能不生效 by z00190439 2014-03-14*/
...
/*Start for DTS2014022206690  2.4G 设置为20M WMM功能不生效 by z00190439 2014-03-14*/
#if defined(CONFIG_ARCH_SD56XX) 
       (*pskb)->accelmark|=SKB_MARK_DSCP_REMARK_ENABLE;
#endif
/*End for DTS2014022206690  2.4G 设置为20M WMM功能不生效 by z00190439 2014-03-14*/
