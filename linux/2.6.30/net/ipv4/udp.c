...
/*START ADD: z00190439 20130722 FOR DTS2013072507126*/
#ifdef CONFIG_ARCH_SD56XX	
extern int (*hisi_hw_ip_filter)(unsigned int *saddr,unsigned int ip_type);
#endif
/*END ADD: z00190439 20130722 FOR DTS2013072507126*/
...
int udp_sendmsg_irq(struct kiocb *iocb, struct sock *sk, struct msghdr *msg,
		size_t len)
{
	struct inet_sock *inet = inet_sk(sk);
	struct udp_sock *up = udp_sk(sk);
