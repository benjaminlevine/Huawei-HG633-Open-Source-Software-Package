...
/* BEGIN: Added by l00184769, 2013/7/19 For port scan.*/
int sysctl_port_scan __read_mostly = 1;
EXPORT_SYMBOL(sysctl_port_scan);
/* END:   Added by l00184769, 2013/7/19 */
...
#endif
/* BEGIN: Added by z67728, 2010/8/5 For port scan */
    {
		.ctl_name	= NET_IPV4_UDP_PORT_SCAN,
		.procname	= "port_scan",
...
/* BEGIN: Added by z67728, 2010/7/1 For BT control igmp remotly, send number and interval .*/
	{
		.ctl_name	= NET_IPV4_IGMP_SEND_REPORT_NUM,
	...
	{
		.ctl_name	= NET_IPV4_IGMP_SEND_REPORT_INTERVAL,
...
/* END:   Added by z67728, 2010/7/1 */
...
#ifdef CONFIG_DT_QOS
        {
            .ctl_name   = NET_IPV4_IGMP_QUERY_TOS,
            .procname   = "igmp_query_tos",
            .data       = &sysctl_igmp_query_tos,
            .maxlen     = sizeof(int),
            .mode       = 0644,
            .proc_handler   = &proc_dointvec
        },
    /*begin, DT: LAN 侧查询使用wan侧获得的QQIC / Max Resp Code */
        {
            .ctl_name   = NET_IPV4_IGMP_QUERY_QQIC,
            .procname   = "igmp_query_qqic",
            .data       = &sysctl_igmp_query_qqic,
            .maxlen     = sizeof(int),
            .mode       = 0644,
            .proc_handler   = &proc_dointvec
        },
        {
            .ctl_name   = NET_IPV4_IGMP_QUERY_MRT,
            .procname   = "igmp_query_mrt",
            .data       = &sysctl_igmp_query_mrt,
            .maxlen     = sizeof(int),
            .mode       = 0644,
            .proc_handler   = &proc_dointvec
        },
        {
            .ctl_name   = NET_IPV4_IGMP_QUERY_QRV,
            .procname   = "igmp_query_qrv",
            .data       = &sysctl_igmp_query_qrv,
            .maxlen     = sizeof(int),
            .mode       = 0644,
            .proc_handler   = &proc_dointvec
        },
    /*end, DT: LAN 侧查询使用wan侧获得的QQIC / Max Resp Code */
        ...
        {
            .ctl_name   = NET_IPV4_IGMP_RCV_QUERY,
            .procname   = "igmp_rcv_query",
            .data       = &sysctl_igmp_rcv_query,
            .maxlen     = sizeof(int),
            .mode       = 0644,
            .proc_handler   = &proc_dointvec
        },
        {
            .ctl_name   = NET_IPV4_IGMP_SND_REPORT,
            .procname   = "igmp_snd_report",
            .data       = &sysctl_igmp_snd_report,
            .maxlen     = sizeof(int),
            .mode       = 0644,
            .proc_handler   = &proc_dointvec
        },
...
#ifdef CONFIG_ATP_HYBRID_REORDER
        {
            .ctl_name   = NET_IPV4_IPGRE_QUEUE_TIMEOUT,
        ...
        {
            .ctl_name   = NET_IPV4_IPGER_QLEN_MAX,
        ...
        {
            .ctl_name   = NET_IPV4_IPGER_BADSEQ_INTERVAL,
        ...
        {
            .ctl_name   = NET_IPV4_IPGER_KEEPSEQ_ENABLE,
        ...
        {
            .ctl_name   = NET_IPV4_IPGER_SKB_TIMEOUT,
...
#ifdef CONFIG_ATP_ROUTE_BALANCE
        {
            .ctl_name   = NET_IPV4_ROUTEBALANCE_STAT_INTERVAL,
