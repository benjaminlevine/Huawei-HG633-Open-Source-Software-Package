...
static void del_br(struct net_bridge *br)
{
 ...
 /* BEGIN: Modified by h00169677, 2012/7/20   PN:DTS2012071607739  */
 /*br0 always exsist ,no need clear snooping list*/
 #ifdef CONFIG_IGMP_SNOOPING
	//br_igmp_snooping_clear();
 #endif

  #ifdef CONFIG_MLD_SNOOPING
	//br_mld_snooping_clear();
 #endif
 /* END:   Modified by h00169677, 2012/7/20 */
...
static struct net_device *new_bridge_dev(struct net *net, const char *name)
{
	...
	br->igmp_snooping = SNOOPING_BLOCKING_MODE;
#endif
