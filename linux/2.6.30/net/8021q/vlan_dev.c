...
#ifdef CONFIG_DT_QOS
	static unsigned short s_dtQosMarkto8021P[] = {0, 0, 3, 4, 6, 6, 0, 0};
	static unsigned int s_dtQos8021PtoMark[] = {0x0, 0x0, 0x0, 0x2, 0x3, 0x0, 0x5, 0x0};
#endif
...
/* start by m00132836  代码检视:去掉宏控制，成为通用处理 2012-01-14 */
/*START ADD: w00182511 2011/10/19 FOR DTS2011101401839*/
/*start of :DTS2012010301122 vdsl上行时WAN侧报文没有打上802.1p的标记 by m00132836 20120110 */
/*end of :DTS2012010301122 vdsl上行时WAN侧报文没有打上802.1p的标记 by m00132836 20120110 */
    int ntp = vlan_dev_info(dev)->nfmark_to_priority;    
...
/*END ADD: w00182511 2011/10/19 FOR DTS2011101401839*/
/* start by m00132836  代码检视:去掉宏控制，成为通用处理 2012-01-14 */
