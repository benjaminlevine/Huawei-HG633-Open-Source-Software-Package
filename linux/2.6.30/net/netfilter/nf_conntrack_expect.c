...
int nf_conntrack_expect_init(struct net *net)
{
    ...
    if (nf_ct_expect_max < 64)
    {
        nf_ct_expect_max = 64;
    }
#endif
//使用FULL CONE时会建连接预期，设置和nf_conntrack_max一样大
#ifdef CONFIG_IP_NF_TARGET_CONENAT
    nf_ct_expect_max = 8112;
#endif

	/* Start of added by f00120964 for modify the expect value  
	According to DT' solution,the default value is 48,very small.When alg service or tr069 service reach which need to 
    ebtables many expect conntrack,so it is easy to full. 2013-1-15 */
    nf_ct_expect_max = 4000;
	/* End of added by f00120964 for modify the expect value 2013-1-15*/
