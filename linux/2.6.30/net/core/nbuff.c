...
FkBuff_t * fkb_unshare(FkBuff_t * fkb_p)
{
    ...
    if ( unlikely(_is_fkb_cloned_pool_(fkb_p)) )     /* Cloned FKB */
    {
        ...
        if ( _get_master_users_(fkb_p->master_p) > 1 )
        {
            ...
            /*START ADD: LIQI 20111223 FOR  DTS2011111005620*/
//#if CONFIG_BCM_EXT_SWITCH//DTS2012052409336 & DTS2012060107085 
            if (fkbM_p == FKB_NULL)
            {
...
//#endif
            /*END ADD: LIQI 20111223 FOR  DTS2011111005620*/
                          ...
                          uint32_t len, uint32_t alignMask)
{
    ...
    else
    {
       ...
       /*END ADD: LIQI 20111223 FOR  DTS2011111005620*/
        ...
        /*START MODIFY: LIQI 20111223 FOR  DTS2011111005620*/
#ifdef CONFIG_BCM_EXT_SWITCH
...
#endif
#endif
        /*END MODIFY: LIQI 20111223 FOR  DTS2011111005620*/
    }
