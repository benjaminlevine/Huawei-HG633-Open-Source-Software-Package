...
#define AMBA_UART_DR	(*(volatile unsigned char *)0x1010F000)
//#define AMBA_UART_LCRH	(*(volatile unsigned char *)0x1010F)
//#define AMBA_UART_CR	(*(volatile unsigned char *)0x1010F)
#define AMBA_UART_TFL	(*(volatile unsigned char *)0x1010F07C)
#define AMBA_UART_FR	(*(volatile unsigned char *)0x1010F014)
