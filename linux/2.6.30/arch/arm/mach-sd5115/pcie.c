...
/*pcie0 & pcie1 sel:*/
static unsigned int pcie0_sel = pcie_sel_none;	/*pcie0 controller is not selected*/
static unsigned int pcie1_sel = pcie1_x1_sel;  /*default controller is pcie1 */
