...
#define PCIE_IOMUX_BASE         (0x14900000) //SYSCTRL
#define PCIE_CRG_BASE           (0x14880000) //SYSCTRL
#define PCIE_GPIO_BASE          (0x10108000) //SYSCTRL
#define PCIE_GPIO_BASE_CHIP_T   (0x10106000) //SYSCTRL  //第一组GPIO管脚
